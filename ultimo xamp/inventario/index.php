...
<body class="index is-preload" onload="document.getElementById('cursor').focus()">
	<header id="header" class="alt">
		<div id="page-wrapper">
			...
			<table>
				...
				<td>
					<h1 id="logo">
						<center><a>CONTROL DE INVENTARIO </a></center>
					</h1>
				</td>
				<td align='right'> <?= $_SESSION['name'] ?> <a href="cerrar-sesion.php" style="color:white;"><i
							class="fas fa-sign-out-alt"></i>Cerrar Sesión</a> </td>
		...
		<form action="ajuste_exis.php" method="post">
			<Table>
				<tr>
					...
					<td class="td0"> COD_ARTICULO: <input type="text" name="field1" id="cursor" />
					<td>&#160;&#160;</td>
					</td>

					<td class="td0"> LOTE:<br>

						<input type="text" name="field5" class="inputb" id="cursor" />
					<td>&#160;&#160;</td>
					</td>
					</td>

					<td class="td0">CANTIDAD: <input type="text" name="field6" class="inputb" id="cursor" /></td>
					<td>&#160;&#160;</td>
					<td class="td0"> FECHA VENC:<br> <input type="date" name="fechav" /></td>


				<tr>
					<td class="td0"></td>
					<td class="td0"></td>
					<td class="td0"><br><input type="submit" value="ENTRADA" /></td>
				</tr>
				</tr>
		...
		<form action="ajuste_exis_salida.php" method="post">
			<Table>
				...
				<tr>
					<td class="td0"></td>
					<td class="td0"></td>
					<td class="td0"><br><input type="submit" value="SALIDA" /></td>
				</tr>
				</tr>
