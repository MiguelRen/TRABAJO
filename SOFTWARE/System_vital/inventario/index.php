...
<Table>						
 ...
 <input type="text" name = "field5" class="inputb" id="cursor" /><td>&#160;&#160;</td></td> 
   </td>
   
   <td class="td0" >CANTIDAD: <input type="text" name = "field6" class="inputb" id="cursor" /></td> <td>&#160;&#160;</td>
   <td class="td0" > FECHA VENC:<br> <input type="date" name = "fechav" /></td>
   
   
 <tr><td class="td0" ></td><td class="td0" ></td><td class="td0" ><br><input type="submit" value="ENTRADA" /></td>  </tr> </tr> 
...
<Table>						
 ...
 <tr><td class="td0" ></td><td class="td0" ></td><td class="td0" ><br><input type="submit" value="SALIDA" /></td>  </tr> </tr> 
